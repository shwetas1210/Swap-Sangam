  ...
  return (
   <>
    <div className=' max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row'>
        <div className=' order-2 md:order-1 w-1/2 mt-10 md:mt-24'>
            <div className='space-y-9'>
            <h1 className='text-4xl font-bold'>Hello! Welcome to <spam className="text-purple-800">SwapSangam</spam></h1>
        ...
        <div className='order-1 w-1/2 mt-10 md:mt-24 ml-10'>
